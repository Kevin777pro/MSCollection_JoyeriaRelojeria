...
{
    /// <inheritdoc />
    public partial class UpdateInventarioModel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Metodos de pago", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Material = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    ...
                    ImagenURL = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PagoFactura", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PagoFactura_Factura",
                        column: x => x.FacturaId,
                        principalTable: "Facturas",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PagoFactura_Metodos de pago1",
                        column: x => x.MetodoPagoId,
                        principalTable: "Metodos de pago",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PagoFactura_MetodoPagoId",
                table: "PagoFactura",
                column: "MetodoPagoId");
